// Netlify function: accepts order details + base64 image, uploads to Cloudinary (unsigned preset) or imgbb fallback,
// then sends the order details + image to the shop owner's WhatsApp using the WhatsApp Cloud API (if configured).
// Deploy this file as `netlify/functions/place_order.js` and set environment variables in Netlify dashboard.
