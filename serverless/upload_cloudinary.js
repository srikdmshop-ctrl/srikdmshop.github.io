// Sample serverless function that accepts a base64 image and uploads to Cloudinary
// Recommended deployment: Vercel API route (save as `api/upload_cloudinary.js`).
